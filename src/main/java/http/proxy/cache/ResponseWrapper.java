...
public class ResponseWrapper {
    ...
    /**
     * Создает копию. В Response читать тело можно только один раз.
     * Поэтому здесь оно передается отдельно и заново инициализируется Response,
     * чтобы тело не было отмечено как прочитанное.
     *
    ...
    /**
     * Создает копию данной обертки. Основное внимание уделяется телу
     * ответвета, которое копируется.
     * @return копия данной обертки
     */
